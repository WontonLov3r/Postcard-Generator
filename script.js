...
states.onchange = function () {
    ...
    //select the innerHTML of element with the ID "state-heading", and assign it with the value of the selected state from the drop down menu 
    document.getElementById('state-heading').innerHTML = states.options[states.selectedIndex].text

    //select the innerHTML of element with the ID "greeting", and assign it with the value of "Greetings from:"
